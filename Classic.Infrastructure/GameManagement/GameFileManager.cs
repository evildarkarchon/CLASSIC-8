...
public class GameFileManager : IGameFileManager
{
    ...
    public async Task<GameFileOperationResult> RestoreFilesAsync(string category, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<GameFileOperationResult> RemoveFilesAsync(string category, CancellationToken cancellationToken = default)
    {

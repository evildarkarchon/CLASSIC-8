...
public class PastebinService : IPastebinService, IDisposable
{
    ...
    private static readonly Regex PastebinUrlRegex = new(@"^https?://pastebin\.com/(\w+)$", RegexOptions.Compiled | RegexOptions.IgnoreCase);
    ...
    private static async Task<string> SaveContentToFileAsync(string rawUrl, string content, CancellationToken cancellationToken)
    {

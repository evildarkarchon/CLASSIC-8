...
public static class PlatformCompatibilityChecker
{
    ...
    private static FileSystemCapabilities CheckFileSystemCapabilities()
    {
        ...
        try
        {
            ...
            _logger.Information(
                "File system capabilities: AppData={CanAccessApplicationData}, Documents={CanAccessDocuments}, CreateDir={CanCreateDirectories}",
    ...
    private static AudioCapabilities CheckAudioCapabilities()
    {
        ...
        try
        {
            ...
            _logger.Information(
                "Audio capabilities: ConsoleBeep={SupportsConsoleBeep}, Linux(PA={HasPulseAudio}, ALSA={HasAlsa}), macOS(CA={HasCoreAudio}, OSA={HasOsaScript})",

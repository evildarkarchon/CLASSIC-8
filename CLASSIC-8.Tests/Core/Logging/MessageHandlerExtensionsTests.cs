...
public class MessageHandlerExtensionsTests : IDisposable
{
    ...
    {
        _handler = new MessageHandler(null, false);
    ...
    public void MessageHandler_ThrowsWhenNotInitialized()
    {
        ...
        var handlerField = handlerType.GetField("_messageHandler", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
